      ...
      <div className="app-container">
        ...
        <div className="app-content">
          <Routes>
            ...
            />
            <Route
              path="/transacoes-de-TI/conectividade/Conectividade"
              element={<Conectividade />}
            />
            <Route
              path="/transacoes-de-TI/Atendimento/Atendimento"
              element={<Atendimento />}
            />
            <Route
            ...
            />
            <Route
              path="/transacoes-de-TI/Colaboraçao/Colaboracao"
              element={<Colaboracao />}
            />
            <Route
              path="/transacoes-de-TI/Telefonia/Telefonia"
              element={<Telefonia />}
            />
            ...
            />
            <Route
              path="/Grandes movimentos/Canais Digitais/Canais"
              element={<Canais />}
            />
            <Route
              path="/Grandes movimentos/Canais Digitais/CanaisPF"
              element={<CanaisPF />}
            />
            <Route
              path="/Grandes movimentos/Canais Digitais/CanaisPJ"
              element={<CanaisPJ />}
            />
            <Route
              path="/Grandes movimentos/Canais Digitais/Whatsapp"
              element={<Whtsapp />}
            />

            {/* Governança e Gestão */}
            <Route
              path="/Governança-e-Gestao/Riscos/Riscos"
              element={<Riscos />}
            />
            <Route
              path="/Governança-e-Gestao/Premiaçoes-e-certificaçoes/Premiacoes"
              element={<Premiacoes />}
            />
            <Route
              path="/Governança-e-Gestao/Portifolio/Portifolio"
              element={<Portifolio />}
            />
            <Route
              path="/Governança-e-Gestao/Pessoas/Pessoas"
              element={<Pessoas />}
            />
            <Route
              path="/Governança-e-Gestao/Investimento-de-TI/Investimento"
            ...
            <Route
              path="/Tecnologias Disruptivas/Tecnologias"
              element={<Tecnologias />}
            />
          </Routes>
        </div>
